            ...
            <table summary="text" class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
				...
				<tr>
                    <td bgcolor="#FFFFFF" width="600" style="padding: 0px 0 0px 0px;" class="logo">
                        <div align="center">
                            <a target="_blank" href="https://www.portalnovarejo.com.br">
                                <img border="0" alt="Portal Novarejo" style="display:block; border:none; outline:none; text-decoration:none;" src="https://s3.amazonaws.com/newsletter-gpadrao/novarejo/2019/05-Maio/17-05/wrc/img_01.jpg" class="img-nota" />
                            </a>
                        </div>
                    </td>
                </tr>
				...
				<tr>
                    <td bgcolor="#ffffff" style="font-family: Helvetica, arial, sans-serif; color: #000000; text-align:left;line-height:40px; padding: 20px 20px; font-size: 40px">
                        <div style="color: #000000;color:#000;">
                            <a target="_blank" href="'.$nvWRC->link[0].'" style="color:#000;">
...
'.$nvWRC->titulo[0].'
                ...
                <tr>
                    <td bgcolor="#FFFFFF" align="center" width="600" style="padding: 0px 0 0px 0px;" class="logo">
                        <div align="center">
                            <a target="_blank" href="'.$nvWRC->link[0].'">
                                <img border="0" alt="'.$nvWRC->titulo[0].'" style="display:block; border:none; outline:none; text-decoration:none; width:95%; text-align:center; margin:0 auto;" src="'.$nvWRC->imagem[0].'" class="img-nota" />
                            </a>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#fff" align="left" style="font-family: helvetica, arial, sans-serif; font-size: 15px; text-align:left; line-height: 20px; padding: 10px 20px 20px;color:#696969;background-color:#fff;">'.$nvWRC->linhaFina[0].'</td>
                </tr>
                <tr>
...
<a target="_blank" href="'.$nvWRC->link[0].'" style="color:#000; font-size:15px; text-decoration:none;">
<b><img src="https://portalnovarejo.com.br/ns/2019/05-Maio/16-05/wrc/images/img_02.jpg" alt="Compartilhe no Facebook" width="97" height="29" border="0" style="padding-left:1px; width:97px!important;vertical-align:bottom" /> </b></a>                            &nbsp; <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url='.$nvWRC->link[0].'&title=&summary=&source=" style="text-decoration:none;">                                                                                                    <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-linkedin.png" alt="Compartilhe no Facebook" width="26" border="0" style="padding-left:1px; width:26px!important;vertical-align:bottom" />                                                                                              </a> &nbsp;                                                                                                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='.$nvWRC->link[0].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-facebook.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:27px!important;vertical-align:bottom"/>
</a>
 &nbsp;
<a target="_blank" href="https://twitter.com/home?status='.$nvWRC->link[0].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-twitter.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:27px!important;vertical-align:bottom"/>
</a> &nbsp;<a target="_blank" href="https://api.whatsapp.com/send?text=Veja esta matéria:'.$nvWRC->link[0].'" style="text-decoration:none;">
				...
				<tr>
                    <td bgcolor="#FFFFFF" width="600" style="padding: 0px 0 0px 0px;" class="logo">
                        <div align="center">
                                ...
                                <img border="0" alt="Portal Novarejo" style="display:block; border:none; outline:none; text-decoration:none;" src="https://s3.amazonaws.com/newsletter-gpadrao/novarejo/2019/05-Maio/17-05/wrc/img_03.jpg" class="img-nota" />
           ...
           <div style="background:#e7af29;width:252px; height:10px; margin 0 auto;"></div>
                                                ...
                                                <tr>
                                                    <td width="280" height="180" align="center" class="devicewidth" bgcolor="#343432">
                                                        <a target="_blank" href="'.$nvWRC->link[1].'">
                                                            <img class="img-nota-media" alt="Portal Novarejo" border="0" src="'.$nvWRC->imagem[1].'" style="width:90%; display: inline-block; text-align:left;" title="Portal Novarejo" />
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
...
<a target="_blank" href="'.$nvWRC->link[1].'" style="text-transform:uppercase;color:#fff; text-decoration:none;">

<b>'.$nvWRC->titulo[1].'</b></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                               
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; text-align:left;line-height: 20px; padding: 0px 10px 0; color:#fff" bgcolor="#343432">'.$nvWRC->linhaFina[1].'</td>
                                                                </tr>
                                                                <tr>
...
<a target="_blank" href="'.$nvWRC->link[1].'" style="color:#fff; font-size:13px; text-decoration:none;">
...
<img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-whatsapp.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/></a>
           ...
           <div style="background:#e7af29;width:252px; height:10px; margin 0 auto;"></div>
                                                ...
                                                <tr>
                                                    <td width="280" height="180" align="center" class="devicewidth" bgcolor="#343432">
                                                        <a target="_blank" href="'.$nvWRC->link[2].'">
                                                            <img class="img-nota-media" alt="Portal Novarejo" border="0" src="'.$nvWRC->imagem[2].'" style="width:90%; display: inline-block; text-align:left;" title="Portal Novarejo" />
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table summary="text" width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner table-lateral">
                                                            <tbody>
                                                                <tr>
                                                                    <td bgcolor="#343432" style="font-family: Helvetica, arial, sans-serif; font-size: 16px; text-align:left;line-height:20px; padding: 0px 0px 0 5px; background-color:#343432">
                                                                        <div class="" style="padding: 5px 10px">
<a target="_blank" href="'.$nvWRC->link[2].'" style="text-transform:uppercase;color:#fff; text-decoration:none;">

<b>'.$nvWRC->titulo[2].'</b></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                               
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; text-align:left;line-height: 20px; padding: 0px 10px 0; color:#fff" bgcolor="#343432">'.$nvWRC->linhaFina[2].'</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="100%" height="10" bgcolor="#343432"></td>
                                                                </tr>
                                                                    ...
                                                                    <td bgcolor="#343432">
                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="tablet-button" summary="text" bgcolor="#2c2c2c">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="103" align="left" style=" background-color:#343432; color:#ffffff;padding: 0px 0 0px 15px;text-align:left;font-size:13px; ">   <span style="color:#ffffff;background-color:#343432;">                                     
<a target="_blank" href="'.$nvWRC->link[2].'" style="color:#fff; font-size:13px; text-decoration:none;">

<b><img src="https://portalnovarejo.com.br/ns/2019/05-Maio/16-05/wrc/images/img_04.jpg" alt="Compartilhe no Facebook" width="97" height="29" border="0" style="padding-left:1px; width:97px!important;vertical-align:bottom" /> </b></a>      </b>                                                                                                                                                </span> 
                    </td>
                                                                                    <td width="148" align="left" style=" background-color:#343432; background-clip: padding-box; color:#ffffff; padding: 0px 7px;">    <span style="color:#ffffff;background-color:#343432;">
                               
                          <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url='.$nvWRC->link[2].'&title=&summary=&source=" style="text-decoration:none;">                                                                                                    <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-linkedin.png" alt="Compartilhe no Facebook" width="26" border="0" style="padding-left:1px; width:22px!important;vertical-align:bottom" />                           &nbsp;                                                                    </a>                                                                                                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='.$nvWRC->link[2].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-facebook.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>
  &nbsp;
<a target="_blank" href="https://twitter.com/home?status='.$nvWRC->link[2].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-twitter.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>  &nbsp;<a target="_blank" href="https://api.whatsapp.com/send?text=Veja esta matéria:'.$nvWRC->link[2].'" style="text-decoration:none;">
...
<img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-whatsapp.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/></a>
           ...
           <div style="background:#e7af29;width:252px; height:10px; margin 0 auto;"></div>
                                                ...
                                                <tr>
                                                    <td width="280" height="180" align="center" class="devicewidth" bgcolor="#343432">
                                                        <a target="_blank" href="'.$nvWRC->link[3].'">
                                                            <img class="img-nota-media" alt="Portal Novarejo" border="0" src="'.$nvWRC->imagem[3].'" style="width:90%; display: inline-block; text-align:left;" title="Portal Novarejo" />
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table summary="text" width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner table-lateral">
                                                            <tbody>
                                                                <tr>
                                                                    <td bgcolor="#343432" style="font-family: Helvetica, arial, sans-serif; font-size: 16px; text-align:left;line-height:20px; padding: 0px 0px 0 5px; background-color:#343432">
                                                                        <div class="" style="padding: 5px 10px">
<a target="_blank" href="'.$nvWRC->link[3].'" style="text-transform:uppercase;color:#fff; text-decoration:none;">

<b>'.$nvWRC->titulo[3].'</b></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                               
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; text-align:left;line-height: 20px; padding: 0px 10px 0; color:#fff" bgcolor="#343432">'.$nvWRC->linhaFina[3].'</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="100%" height="10" bgcolor="#343432"></td>
                                                                </tr>
                                                                    ...
                                                                    <td bgcolor="#343432">
                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="tablet-button" summary="text" bgcolor="#2c2c2c">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="103" align="left" style=" background-color:#343432; color:#ffffff;padding: 0px 0 0px 15px;text-align:left;font-size:13px; ">   <span style="color:#ffffff;background-color:#343432;">                                     
<a target="_blank" href="'.$nvWRC->link[3].'" style="color:#fff; font-size:13px; text-decoration:none;">

<b><img src="https://portalnovarejo.com.br/ns/2019/05-Maio/16-05/wrc/images/img_04.jpg" alt="Compartilhe no Facebook" width="97" height="29" border="0" style="padding-left:1px; width:97px!important;vertical-align:bottom" /> </b></a>      </b>                                                                                                                                                </span> 
                    </td>
                                                                                    <td width="148" align="left" style=" background-color:#343432; background-clip: padding-box; color:#ffffff; padding: 0px 7px;">    <span style="color:#ffffff;background-color:#343432;">
                               
                          <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url='.$nvWRC->link[3].'&title=&summary=&source=" style="text-decoration:none;">                                                                                                    <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-linkedin.png" alt="Compartilhe no Facebook" width="26" border="0" style="padding-left:1px; width:22px!important;vertical-align:bottom" />                           &nbsp;                                                                    </a>                                                                                                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='.$nvWRC->link[3].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-facebook.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>
  &nbsp;
<a target="_blank" href="https://twitter.com/home?status='.$nvWRC->link[3].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-twitter.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>  &nbsp;<a target="_blank" href="https://api.whatsapp.com/send?text=Veja esta matéria:'.$nvWRC->link[3].'" style="text-decoration:none;">
...
<img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-whatsapp.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/></a>
           ...
           <div style="background:#e7af29;width:252px; height:10px; margin 0 auto;"></div>
                                                ...
                                                <tr>
                                                    <td width="280" height="180" align="center" class="devicewidth" bgcolor="#343432">
                                                        <a target="_blank" href="'.$nvWRC->link[4].'">
                                                            <img class="img-nota-media" alt="Portal Novarejo" border="0" src="'.$nvWRC->imagem[4].'" style="width:90%; display: inline-block; text-align:left;" title="Portal Novarejo" />
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table summary="text" width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner table-lateral">
                                                            <tbody>
                                                                <tr>
                                                                    <td bgcolor="#343432" style="font-family: Helvetica, arial, sans-serif; font-size: 16px; text-align:left;line-height:20px; padding: 0px 0px 0 5px; background-color:#343432">
                                                                        <div class="" style="padding: 5px 10px">
<a target="_blank" href="'.$nvWRC->link[4].'" style="text-transform:uppercase;color:#fff; text-decoration:none;">

<b>'.$nvWRC->titulo[4].'</b></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                               
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; text-align:left;line-height: 20px; padding: 0px 10px 0; color:#fff" bgcolor="#343432">'.$nvWRC->linhaFina[4].'</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="100%" height="10" bgcolor="#343432"></td>
                                                                </tr>
                                                                    ...
                                                                    <td bgcolor="#343432">
                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="tablet-button" summary="text" bgcolor="#2c2c2c">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="103" align="left" style=" background-color:#343432; color:#ffffff;padding: 0px 0 0px 15px;text-align:left;font-size:13px; ">   <span style="color:#ffffff;background-color:#343432;">                                     
<a target="_blank" href="'.$nvWRC->link[4].'" style="color:#fff; font-size:13px; text-decoration:none;">

<b><img src="https://portalnovarejo.com.br/ns/2019/05-Maio/16-05/wrc/images/img_04.jpg" alt="Compartilhe no Facebook" width="97" height="29" border="0" style="padding-left:1px; width:97px!important;vertical-align:bottom" /> </b></a>      </b>                                                                                                                                                </span> 
                    </td>
                                                                                    <td width="148" align="left" style=" background-color:#343432; background-clip: padding-box; color:#ffffff; padding: 0px 7px;">    <span style="color:#ffffff;background-color:#343432;">
                               
                          <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url='.$nvWRC->link[4].'&title=&summary=&source=" style="text-decoration:none;">                                                                                                    <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-linkedin.png" alt="Compartilhe no Facebook" width="26" border="0" style="padding-left:1px; width:22px!important;vertical-align:bottom" />                           &nbsp;                                                                    </a>                                                                                                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='.$nvWRC->link[4].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-facebook.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>
  &nbsp;
<a target="_blank" href="https://twitter.com/home?status='.$nvWRC->link[4].'" style="text-decoration:none;">                                                                                  <img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-twitter.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/>
</a>  &nbsp;<a target="_blank" href="https://api.whatsapp.com/send?text=Veja esta matéria:'.$nvWRC->link[4].'" style="text-decoration:none;">
...
<img src="https://s3.amazonaws.com/newsletter-gpadrao/padrao/redes-sociais/quadrado-preto/icon-whatsapp.png" alt="Compartilhe no Twitter" width="27" border="0" style=" width:22px!important;vertical-align:bottom;padding-left:3px;"/></a>
                        ...
                        <div align="center"> <a href="https://www.consumidormoderno.com.br/" target="_blank"><img border="0" alt="Portal Novarejo" style="display:block; border:none; outline:none; text-decoration:none;" src="https://portalnovarejo.com.br/ns/2019/05-Maio/16-05/wrc/images/img_05.jpg" class="img-nota" /></a>
                     ...
                     <b>
                     <a href="https://www.portalnovarejo.com.br" target="_blank" style="text-decoration: none;color:white;">www.portalnovarejo.com.br</a></b></td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#000000" style="padding:10px 0;background:#000000!important;">
                                                            ...
                                                            <p style="font-family: Helvetica, arial, sans-serif; font-size: 12px; text-align:center;">
                                                                <a target="_blank" href="https://www.facebook.com/novarejo" style="text-decoration:none">
...
" alt="Siga no Facebook" width="20" height="20" border="0" style="width: 20px !important" title="Siga no Facebook" />
                                                                ...
                                                                <a target="_blank" href="https://twitter.com/NOVAREJO" style="text-decoration:none">
...
" alt="Siga no Twitter" width="20" height="20" border="0" style="width: 20px !important; padding-left:5px" title="Siga no Twitter" />
                                                                ...
                                                                <a target="_blank" href="https://www.linkedin.com/groups/4158873/profile" style="text-decoration:none">
...
" alt="Grupo no Linkedin" width="20" height="20" border="0" style="width: 20px !important; padding-left:5px" title="Grupo no Linkedin" />
                                                                ...
                                                                <a target="_blank" href="https://www.youtube.com/user/CMNoVarejo" style="text-decoration:none">
...
" alt="Siga no YouTube" width="20" height="20" border="0" style="width: 20px !important; padding-left:5px" title="Siga no YouTube" />
                                                                ...
                                                                <a target="_blank" href="https://www.instagram.com/novarejo/" style="text-decoration:none">
