...
?>
    ...
    <div class="right_col" role="main">
        <h1>CM Especial Viva Tech</h1>
        <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="controller/visualizarCM_vivatech.php" target="_blank">
