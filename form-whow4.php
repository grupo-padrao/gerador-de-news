...
?>
    ...
    <div class="right_col" role="main">
        <h1>News WHOW</h1>
        <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="controller/visualizar_whow4.php" target="_blank">
                    ...
                    <div class="x_panel" >
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="input-group demo2 colorpicker-element">
                                        <span class="input-group-addon" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="252x234">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="input-group demo2 colorpicker-element">
                                        <span class="input-group-addon" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="540x190">
