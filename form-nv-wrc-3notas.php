...
?>
    ...
    <div class="right_col" role="main">
        <h1>Novarejo WRC - 3 Notas</h1>
        <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="controller/visualizarNV_WRC-3notas.php" target="_blank">
