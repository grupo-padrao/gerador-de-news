...
?>
    ...
    <div class="right_col" role="main">
        <h1>Portal CM Especial</h1>
        <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="controller/visualizarCM_especial.php" target="_blank">
