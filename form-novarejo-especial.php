...
?>
    ...
    <div class="right_col" role="main">
        <h1>Portal Novarejo Especial</h1>
        <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="controller/visualizarNV_especial.php" target="_blank">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="input-group demo2 colorpicker-element">
                                        <span class="input-group-addon" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Largura 600 x Por altura relativa">

                                            <span class="fa fa-image"></span>
                                        </span>
                                        <input type="text" class="form-control" name="topo">
                                    </div>
                                </div>
                            </div>
